...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '𝗚𝗔𝗧𝗘𝗪𝗔𝗬𝘛𝘖𝗔𝗚𝗜', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '𝑝𝑟𝑜𝑚𝑝𝑡. 𝑓𝑙𝑜𝑤. 𝑟𝑒𝑝𝑜. 𝑝𝑎𝑝𝑒𝑟. 𝑟𝑜𝑏𝑜𝑡.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gatewaytoagi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, AI, Blog, 笔记, AGI', // 网站关键词 英文逗号隔开
