...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif'>Powered By  (Donate BTC/ETH to)<a href='mailto:uncle.jason@qq.com' className='underline text-gray-500 dark:text-gray-300'>  𝘅𝘉𝘳𝘢𝘪𝘯.𝖾𝗍𝗁</a></div>
